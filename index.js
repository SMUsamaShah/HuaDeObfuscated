...
// ─── Math aliases ───────────────────────────────────────────────────────────
const { max, min, abs, round, floor, ceil, pow, sqrt, sign } = Math;
...
function initApp() {
  ...
  WW = floor(W_FULL / GRIDSZ) * GRIDSZ;
  HH = floor(H_FULL / GRIDSZ) * GRIDSZ;
